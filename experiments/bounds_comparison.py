...
def main():
    ...
    rmax_vi_agent = RMaxVI(actions=mdp1.get_actions(), gamma=.9, count_threshold=20)
    lrmax_agent = LRMax(actions=mdp1.get_actions(), gamma=0.9, count_threshold=20)

    # Run
    run_agents_on_mdp([rmax_vi_agent, rand_agent], mdp1, instances=5, episodes=10, steps=40,
