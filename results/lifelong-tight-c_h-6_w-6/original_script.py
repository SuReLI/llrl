...
NEW_PARAM = [
    {'size': 6, 'n_tasks': 50, 'n_episodes': 50, 'n_steps': 4, 'n_known': 1, 'stochastic': False, 'v_max': 10.}
]
...
PARAM = [
    ...
    {'size': 6, 'n_tasks': 50, 'n_episodes': 50, 'n_steps': 4, 'n_known': 1, 'stochastic': True, 'v_max': 10.},  # 00:12
