...
def experiment():
    # Parameters
    gamma = .9
    env_distribution = make_env_distribution(env_class='deterministic-tight-super-big', env_name='deterministic-tight-super-big',
                                             gamma=gamma)
    ...
    # Run
    run_agents_lifelong(agents_pool, env_distribution, n_instances=2, n_tasks=100, n_episodes=100, n_steps=100,
