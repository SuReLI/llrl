...
def run_single_agent_on_mdp(
        agent, mdp, episodes, steps, experiment=None, verbose=False, track_disc_reward=False,
        reset_at_terminal=False, resample_at_terminal=False, is_tracked_value_discounted=False
):
    '''
    Summary:
    ...
    for episode in range(1, episodes + 1):
        ...
        for step in range(1, steps + 1):
            ...
            # Track value.
            if is_tracked_value_discounted:
                value_per_episode[episode - 1] += reward * (gamma ** step)
            else:
                value_per_episode[episode - 1] += reward
