...
def experiment():
    # Parameters
    gamma = .9
    env_distribution = make_env_distribution(env_class='soft-tight', env_name='tight', gamma=gamma)
    ...
    # Run
    run_agents_lifelong(agents_pool, env_distribution, n_instances=4, n_tasks=80, n_episodes=80, n_steps=100,
